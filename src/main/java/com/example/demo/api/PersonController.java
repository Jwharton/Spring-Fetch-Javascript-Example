...
public class PersonController {
    ...
    public Person getPersonByID(@PathVariable("id") String personId) {
        return personService.getPersonByID(personId).orElse(null);
    }
    ...
    @PutMapping(path = "{id}")
    public void updatePerson(@PathVariable("id") String personId, @Valid @NotNull @RequestBody Person personToUpdate){
